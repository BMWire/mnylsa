...
$sql = "INSERT INTO gallery_orders (user_id, user_name, gallery_id, gallery_title, gallery_fee) VALUES ('$_SESSION[user_id]', '$_SESSION[user_name]', '$_SESSION[gallery_id]', '$_SESSION[gallery_title]', '$_SESSION[gallery_fee]')";
